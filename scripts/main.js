let customers = [
  ...
  //loop within a loop - run .map on the customers array to create a new array, then create an empty array. We fill that array by drilling down to customer.contacts.email and run a forEach on this to pull the email addresses. Emails are pushed to empty array.
...
//use .flat() to be able to see just the email array
